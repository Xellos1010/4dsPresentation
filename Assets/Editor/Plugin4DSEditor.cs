...
namespace unity4dv
{
    ...
    public class Plugin4DSEditor : Editor
    {
        ...
        {
            myTarget = (Plugin4DS)target;
            sequenceNames = serializedObject.FindProperty("SequenceNames");
        ...
        private void BuildFilesInspector(Plugin4DS myTarget)
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("SequenceNames"));
        ...
        SerializedProperty sequenceNames;
        private void BuildCustomFunctions()
        {
            if(GUILayout.Button("Get Sequence Names"))
            {
                myTarget.GetSequenceNames();
                sequenceNames = serializedObject.FindProperty("SequenceNames");
                serializedObject.ApplyModifiedProperties();
                myTarget.Initialize();
            }
            if (GUILayout.Button("Set and load Next Sequence"))
            {
                myTarget.NextSequence();
            }
        }
    }
